   ...
   <div class="home-section-four pt-5">
               ...
               <div class="col-lg-3 col-6">
                  <div class="tab-one">
                     <div class="tab-one-padding">
                        <h4 class="tab-one-heading fw-bolder">{{$num_actions}}</h4>
               ...
               <div class="col-lg-3 col-6">
                  <div class="tab-two">
                     <div class="tab-two-padding">
                        <h4 class="tab-two-heading fw-bolder">{{$num_review}}</h4>
               ...
               <div class="col-lg-3 col-6">
                  <div class="tab-three">
                     <div class="tab-three-padding">
                        <h4  class="tab-three-heading fw-bolder">{{$num_approved}}</h4>
               ...
               <div class="col-lg-3 col-6">
                  <div class="tab-four">
                     <div class="tab-four-padding fw-bolder">
                        <h4  class="tab-four-heading">{{$num_removed}}</h4>
                        <p  class="fw-500 fs-16p mb-0">Removed from Sales</p>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-action" role="tabpanel" aria-labelledby="pills-action-tab">
               <div class="tab-body-section" style="margin-top: 30px;">
                  @isset($action_releases)
                  @foreach($action_releases as $action)
                        ...
                        <div class="row">
                           <div class="col-xl-2 col-lg-2 col-6">
                              <div class="pt-3 pl-3 pb-2 image-section">
                                @isset($artwork[$loop->index]->image)
                                 <img src="{{asset('storage/'.$artwork[$loop->index]->image)}}">
                                @endisset
                              </div>
                           </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-md-12">
                                    <div class="pt-3 text-section-2">
                                       <div class="d-flex">
                                          <i class="fas fa-check-circle clr-green pt-1"></i>
                                       </div>
                                    </div>
                                 </div>
                                 <!-- TWO -->
      ...
      <div class="tab-two-content">
        <div class="tab-content" id="pills-tabContent">
           <div class="tab-pane fade show active" id="pills-action" role="tabpanel" aria-labelledby="pills-action-tab">
              <div class="tab-body-section" style="margin-top: 30px;">
                @isset($review_releases)
                 @foreach($review_releases as $action)
                 ...
                 <div class="track-one">
                    <div class="container-fluid">
                       <div class="row">
                          <div class="col-xl-2 col-lg-2 col-6">
                             <div class="pt-3 pl-3 pb-2 image-section">
                               @isset($review_artwork[$loop->index]->image)
                                <img src="{{asset('storage/'.$review_artwork[$loop->index]->image)}}">
                               @endisset
                             </div>
                          </div>
                          <div class="col-xl-10 col-lg-10 col-6">
      ...
      <div class="tab-three-content">
        <div class="tab-content" id="pills-tabContent">
           <div class="tab-pane fade show active" id="pills-action" role="tabpanel" aria-labelledby="pills-action-tab">
              <div class="tab-body-section" style="margin-top: 30px;">
                @isset($approved_releases)
                 @foreach($approved_releases as $action)
                 ...
                 <div class="track-one">
                    <div class="container-fluid">
                       <div class="row">
                          <div class="col-xl-2 col-lg-2 col-6">
                             <div class="pt-3 pl-3 pb-2 image-section">
                               @isset($approved_artwork[$loop->index]->image)
                                <img src="{{asset('storage/'.$approved_artwork[$loop->index]->image)}}">
                               @endisset
                             </div>
                          </div>
                          <div class="col-xl-10 col-lg-10 col-6">
                             <div class="row">
                                ...
                                <div class="col-xl-12 col-12 d-lg-block d-none">
                                   <div class="d-flex">
                                      ...
                                      <span>
                                      <img style="width: auto;" src="<?php echo asset('assets/images/dashboard/track-icon.png') ?>">
                                      &nbsp;{{$approved_track[$loop->index]}} Track
                                      </span>
                                   </div>
                                </div>
                                <!-- THREE -->
      ...
      <div class="tab-four-content">
        <div class="tab-content" id="pills-tabContent">
           <div class="tab-pane fade show active" id="pills-action" role="tabpanel" aria-labelledby="pills-action-tab">
              <div class="tab-body-section" style="margin-top: 30px;">
                @isset($removed_releases)
                 @foreach($removed_releases as $action)
                 ...
                 <div class="track-one">
                    <div class="container-fluid">
                       <div class="row">
                          <div class="col-xl-2 col-lg-2 col-6">
                             <div class="pt-3 pl-3 pb-2 image-section">
                               @isset($removed_artwork[$loop->index]->image)
                                <img src="{{asset('storage/'.$removed_artwork[$loop->index]->image)}}">
                               @endisset
                             </div>
                          </div>
                          <div class="col-xl-10 col-lg-10 col-6">
                             <div class="row">
                                ...
                                <div class="col-xl-12 col-12 d-lg-block d-none">
                                   <div class="d-flex">
                                      ...
                                      <span>
                                      <img style="width: auto;" src="<?php echo asset('assets/images/dashboard/track-icon.png') ?>">
                                      &nbsp;{{$removed_track[$loop->index]}} Track
                                      </span>
                                   </div>
                                </div>
                                <!-- THREE -->
                                <div class="col-xl-9 col-lg-9 col-md-12 d-lg-block d-none">
                                   <div class="pt-3">
                                      <h5>Your Release is Removed</h5>
                                      <p>Our team have noticed that your release did not met with our terms.</p>
                                   </div>
                                </div>
                             </div>
                          </div>
